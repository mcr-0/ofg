    ...
    <div className=" mx-auto w-full">
      <div className="container mx-auto">
        ...
        <div class="w-full  text-center    sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          <h5 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Follow us on TikTok!</h5>
          <p class="text-base text-gray-800 sm:text-lg dark:text-gray-400">
            1. Create an account.
            <br />
          ...
          <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            <a
              href="#"
              class="w-full sm:w-auto bg-black hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
            >
              ...
              <div class="text-left rtl:text-right">
                <div class="mb-1 text-xs">Download TikTok</div>
          ...
          <br />
          <hr />
          <h5 class="mt-6 text-2xl font-bold text-gray-900  dark:text-white">Enter your code:</h5>
